...
Eine Liste der in dieser Version behobenen Probleme finden Sie unter [Behobene Probleme in Version 5.0.0 Service Pack 4](../release-info/fixed-issues-5-0-0-sp4.md).

## Kompatibilitätsmatrix

In diesem Abschnitt wird die Kompatibilitätsmatrix für die Softwareanwendungen aufgelistet, die von Experience Manager Guides 5.0.0 Service Pack 4 unterstützt werden.
...
## Upgrade auf Version 5.0.0 Service Pack 4 von Experience Manager Guides

Sie können Ihre aktuelle Version von Guides einfach auf Version 5.0.0 Service Pack 4 aktualisieren. Bevor Sie mit dem Upgrade auf Version 5.0.0 Service Pack 4 von Experience Manager Guides fortfahren, müssen Sie die folgenden Punkte berücksichtigen:

- Wenn Sie Version 5.0.0 oder 5.0.x verwenden, können Sie direkt auf Version 5.0.0 Service Pack 4 aktualisieren.
