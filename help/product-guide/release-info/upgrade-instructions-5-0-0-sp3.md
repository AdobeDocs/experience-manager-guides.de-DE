---
title: Versionshinweise zu | Aktualisierungsanweisungen für Adobe Experience Manager Guides 5.0.0 Service Pack 3
description: Erfahren Sie mehr über die Kompatibilitätsmatrix und das Upgrade auf Version 5.0.0 Service Pack 3 von Adobe Experience Manager Guides.
...
# Aktualisierungsanweisungen für die Version 5.0.0 Service Pack 3 (Februar 2026)

Dieser Artikel enthält die Upgrade-Anweisungen und die Kompatibilitätsmatrix für Version 5.0.0 Service Pack 3 von Adobe Experience Manager Guides.

Eine Liste der in dieser Version behobenen Probleme finden Sie unter [Behobene Probleme in Version 5.0.0 Service Pack 3](../release-info/fixed-issues-5-0-0-sp3.md).

## Kompatibilitätsmatrix

In diesem Abschnitt wird die Kompatibilitätsmatrix für die Softwareanwendungen aufgelistet, die von Experience Manager Guides 5.0.0 Service Pack 3 unterstützt werden.
...
| Freigabe | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | Unterstützt | 2022 oder höher |
...
## Upgrade auf Version 5.0.0 Service Pack 3 von Experience Manager Guides

Sie können Ihre aktuelle Version von Guides einfach auf Version 5.0.0 Service Pack 3 aktualisieren. Bevor Sie mit dem Upgrade auf Version 5.0.0 Service Pack 3 von Experience Manager Guides fortfahren, müssen Sie die folgenden Punkte berücksichtigen:

- Wenn Sie Version 5.0.0 Service Pack 2, 5.0.0 Service Pack 1 oder 5.0.0 verwenden, können Sie direkt auf Version 5.0.0 Service Pack 3 aktualisieren.
