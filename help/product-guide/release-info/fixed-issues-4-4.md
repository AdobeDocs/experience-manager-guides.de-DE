...
- Der Titel auf der Registerkarte „Webeditor“ wird nach einem Punkt (.) abgeschnitten. Zeichen. (14372)
...
- **AEM Site**-Vorgabe lässt die Auswahl einer Vorlage außerhalb der `/content` im Web-Editor nicht zu. (14260)
