---
title: Versionshinweise | Aktualisierungsanweisungen und behobene Probleme in Adobe Experience Manager Guides, Version Juli 2023
description: Erfahren Sie mehr über die Fehlerbehebungen und wie Sie auf die Adobe Experience Manager Guides as a Cloud Service-Version vom Juli 2023 aktualisieren können.
...
# Adobe Experience Manager Guides as a Cloud Service-Version Juli 2023

In diesem Versionshinweis werden die Aktualisierungsanweisungen, die Kompatibilitätsmatrix und die in Version Juli 2023 von Adobe Experience Manager Guides behobenen Probleme (später als *AEM Guides as a Cloud Service* bezeichnet) beschrieben.

Weitere Informationen zu den neuen Funktionen und Verbesserungen finden Sie unter [Neue Funktionen in der AEM Guides as a Cloud Service-Version vom Juli 2023](whats-new-2023-7-0.md).
...
2. Aktualisieren Sie die Eigenschaft `<dox.version>` in der Datei `/dox/dox.installer/pom.xml` Ihres Cloud Service-Git-Codes auf 2023.7.0.314.
3. Nehmen Sie die Änderungen vor und führen Sie die Cloud Service-Pipeline aus, um auf die AEM Guides as a Cloud Service-Version vom Juli 2023 zu aktualisieren.
...
In diesem Abschnitt wird die Kompatibilitätsmatrix für die Softwareanwendungen aufgelistet, die von der AEM Guides as a Cloud Service-Version vom Juli 2023 unterstützt werden.
...
- Hochladen von Dateien im Sauerstoff-Plugin für AEM Guides funktioniert nicht in Cloud-Services, wenn Sie haben ! im Dateinamen. (12207)
