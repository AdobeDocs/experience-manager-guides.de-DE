...
1. Klicken Sie **Fenster „Vorlagen** auf das Symbol **+** neben **Vorlagen** und wählen Sie **PDF-Vorlage**.
...
1. Bewegen Sie den Mauszeiger über die Vorlage, die Sie duplizieren möchten, wählen Sie das Symbol **…** *Optionen* und wählen Sie **Duplizieren** aus dem Kontextmenü aus.
   ...
   *Wählen Sie eine zu duplizierende Vorlage aus, zeigen Sie die Miniaturansicht an und aktualisieren Sie den Titel im Dialogfeld **PDF-Vorlage**.*
...
>[!NOTE]
>
>Wenn für Ihren Ordner ein Ordnerprofil konfiguriert ist, zeigen Sie nur die PDF-Vorlagen an, die für das Ordnerprofil konfiguriert sind.
...
1. Um die Komponenten einer Vorlage anzuzeigen, führen Sie einen der folgenden Schritte aus:
   ...
   * Bewegen Sie den Mauszeiger über eine beliebige Vorlage und wählen Sie die … (**Options**-Symbol) und wählen **Bearbeiten** aus dem Kontextmenü aus.
   ...
   <img src="assets/customize-pdf-template.png" alt="PDF-Vorlage anpassen" width="350">
   ...
   * Seiten-Layouts: Ein typischer PDF enthält verschiedene Seiten, z. B. ein Titelblatt oder eine Titelseite, Inhaltsverzeichnis, Kapitel, Index, Zitate und mehr. Im Abschnitt Seiten-Layouts können Sie das Erscheinungsbild verschiedener Seiten in PDF gestalten. Weitere Informationen finden Sie unter [Seiten-Layouts](../native-pdf/components-pdf-template.md#page-layouts).
