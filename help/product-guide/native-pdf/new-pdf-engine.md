...
|-------------|------------------------------------------------|
| Skalierte Bilder können aufgrund von Änderungen im Bild-Rendering-Verhalten anders aussehen. | Um das Renderverhalten des Bildes wiederherzustellen, fügen Sie Folgendes hinzu:<br><br><pre><code>„css
Bild-Rendering: pixelig;
&quot;</code></pre> |
