...
Die folgenden Registerkarten enthalten Anweisungen zum Konfigurieren einer benutzerdefinierten DITA-Zuordnungsvorlage basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
...
## Anzahl der Verweise in einer DITA-Zuordnung anpassen (nur für Cloud Service)
