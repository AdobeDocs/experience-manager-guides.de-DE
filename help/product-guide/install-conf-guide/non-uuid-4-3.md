...
> * Wenn Sie eine Version vor 4.3.1 verwenden, aktualisieren Sie auf Version 4.3.1. Befolgen Sie die [Upgrade-](./upgrade-aemg-latest-version.md)), die für die lizenzierte Version Ihres Produkts gelten.
