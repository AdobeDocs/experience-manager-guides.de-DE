...
Die folgenden Registerkarten enthalten Anweisungen zum Konfigurieren eines Connectors basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
...
Sie können mehrere Ressourcen hinzufügen oder verwenden, die auf verschiedenen URLs für einige Connectoren basieren, z. B. Generic REST Client, Salsify, Akeneo und Microsoft Azure DevOps Boards (ADO). Verbinden Sie sich dann mit ihnen, um Inhaltsfragmente oder Themen mithilfe der Generatoren für sie zu erstellen.
...
**Installieren eines Open-Source-Connector-{#install-open-source-connector}**
