...
Wenn Sie ein benutzerdefiniertes Attribut verwenden, muss es sich um ein gültiges DITA-Attribut handeln, das von der DTD unterstützt wird. Die folgenden Registerkarten enthalten Anweisungen zur Verwendung eines beliebigen Attributs, das kein standardmäßiges DITA-Attribut basierend auf Ihrer Experience Manager Guides-Einrichtung ist: Cloud Service oder On-Premise.
...
Die folgenden Registerkarten enthalten Anweisungen zum Konfigurieren der Authoring-Vorlagen basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
...
1. Führen Sie einen der folgenden Schritte aus, um eine Ausgabevorgabe zu erstellen oder zu bearbeiten:
   ...
   - Klicken Sie **Bearbeiten**, um die Konfiguration der ausgewählten Vorgabe zur Bearbeitung zu öffnen.
     ...
     Weitere Informationen zu den Ausgabevorgabeneinstellungen je nach verwendetem Setup finden Sie unter *Grundlegendes zu den Ausgabevorgaben* im Abschnitt Verwenden von Adobe Experience Manager Guides.
...
Die folgenden Registerkarten enthalten Informationen basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
