...
Die folgenden Registerkarten enthalten Anweisungen zum Hinzufügen benutzerdefinierter DITA-Elemente oder -Attribute in der Suchserialisierungsdatei, je nach Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
...
Die folgenden Registerkarten enthalten Anweisungen zum Aktivieren der Option „Metadatenextraktion“ im `configMgr` auf der Grundlage Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Verwenden Sie die Anweisungen unter [Konfigurationsüberschreibungen](download-install-config-override.md#), um die Konfigurationsdatei zu erstellen. Geben Sie in der Konfigurationsdatei die folgenden \(property\)-Details an, um die Option zur Extraktion von Metadaten zu konfigurieren:
...
1. Öffnen Sie die Seite Konfiguration der Adobe Experience Manager-Web-Konsole . Die Standard-URL für den Zugriff auf die Konfigurationsseite lautet:
   ...
   `http://<server name\>:<port\>/system/console/configMgr`B
...
Die folgenden Registerkarten enthalten Anweisungen zum Ausschließen des temporären Übersetzungsordners von der Suche, basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
