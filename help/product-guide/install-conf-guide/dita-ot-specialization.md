...
Die folgenden Registerkarten enthalten Anweisungen zur Verwendung benutzerdefinierter DITA-OT-Plug-ins, die auf Ihrer Experience Manager Guides-Einrichtung basieren: Cloud Service oder On-Premise.
...
>[!NOTE]
>
> Sie können das benutzerdefinierte DITA-Profil als Paket exportieren und auf die anderen AEM Guides-Instanzen hochladen, um Zeit zu sparen. Weitere Informationen finden Sie unter [Anhang](./aemg-appendix.md).
