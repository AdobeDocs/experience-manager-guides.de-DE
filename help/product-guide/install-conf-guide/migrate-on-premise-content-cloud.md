---
title: Migrieren von Inhalten von On-Premise zu Cloud Services
...
Dieser Artikel bietet einen detaillierten, schrittweisen Prozess für die Migration Ihrer On-Premise- oder Managed Services Experience Manager Guides-Inhalte zu Cloud Services, um einen reibungslosen Übergang zur Cloud-basierten Plattform sicherzustellen.

## Voraussetzungen

* Adobe Experience Manager 6.4 oder neuere Versionen
* Experience Manager Guides sollte die UUID-Version verwenden. Wenn Sie eine Nicht-UUID-Version von Adobe Experience Manager Guides verwenden, migrieren Sie zunächst mithilfe der Schritte unter [Migrieren von Nicht-DITA-Inhalten](../install-conf-guide/uuid-non-uuid.md) zu UUID.
...
1. Wählen Sie im **Software Distribution**-Portal die Registerkarte **Adobe Experience Manager as the Cloud Service** aus, suchen Sie nach „Content Transfer Tool“ und laden Sie das Content Transfer Tool-Paket herunter.
...
Installieren Sie das Content Transfer Tool auf der Quell-Veröffentlichungsinstanz, um Inhalte in die Ziel-Veröffentlichungsinstanz zu verschieben.
Das Content Transfer Tool unterscheidet bei der Aufnahme von Inhalten in eine Veröffentlichungsumgebung nicht zwischen veröffentlichten und nicht veröffentlichten Inhalten. Der im Migrationssatz angegebene Inhalt wird in die ausgewählte Zielinstanz aufgenommen. Der Benutzer kann einen Migrationssatz in eine Autoreninstanz, eine Veröffentlichungsinstanz oder in beide aufnehmen.
...
* Während der Aufnahme in die Veröffentlichungsebene wird die Veröffentlichungsebene nicht herunterskaliert (im Gegensatz zur Autorenebene).
* Migrieren Sie nur einen einzelnen Veröffentlichungsknoten. Bevor Sie mit der Extraktion beginnen, entfernen Sie sie aus dem Lastenausgleich.

>[!NOTE]
>
> Stellen Sie als Vorsichtsmaßnahme sicher, dass keine Schreibvorgänge auf den Veröffentlichungsinstanzen stattfinden, einschließlich benutzerinitiierter Aktionen wie:
