...
Die folgenden Registerkarten enthalten Anweisungen zum Automatisieren der Statusänderung des Dokuments basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
...
1. Wählen Sie **Prozessschritt** aus dem Abschnitt **Workflow** des Dialogfelds &quot;AEM&quot; aus und ziehen Sie es per Drag-and-Drop auf den Workflow.
...
AEM Guides bietet einen Workflow für die Dokumentvalidierung, mit dem Sie den Lebenszyklus Ihres Dokumentenentwicklungsprozesses steuern können.

Die folgenden Registerkarten enthalten Anweisungen zum Aktivieren des Validierungs-Workflows basierend auf Ihrer Experience Manager Guides-Einrichtung: Cloud Service oder On-Premise.
