      ...
      - Cloud Services {#cloud-release-notes}
         ...
         - Versionen 2026 {#2026-releases}
            ...
            - Version 2026.03.0 {#2603-release}
               - [Neue Funktionen](./release-info/whats-new-2026-03-0.md)
               - [Behobene Probleme](./release-info/fixed-issues-2026-03-0.md)
               - [Upgrade-Anweisungen](./release-info/upgrade-instructions-2026-03-0.md)
...
- Benutzerhandbuch (neue Benutzeroberfläche) {#user-guide}
   ...
   - Verwalten von Lerninhalten {#learning-training-content}
      - Erste Schritte {#get-started}
         - Einführung {#intro-lc}
            - [Versionshinweise](./release-info-lt/release-notes-lt-2025-12-v2.md)
            - [Versionshinweise](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- Installation und Konfiguration {#install-guide}
   - On-Premise {#on-prem-ig}
      ...
      - Inhaltsmigration {#content-migration}
         ...
         - Migrationsprozess {#migration-process}
            - [4.3.1 Migration von Nicht-UUID zu 4.3.2 UUID-Inhalten](./install-guide/migrate-non-uuid-4-3.md)
            - [4.6.0 Nicht-UUID-zu-4.6.1-UUID-Inhaltsmigration](./install-guide/migrate-non-uuid-uuid-4-6.md)
      ...
      - Editor-Einstellungen {#editor-configs}
         - [Editor-Einstellungen konfigurieren](./install-guide/editor-settings.md)
      ...
      - Arbeiten mit Ausgabegenerierungseinstellungen {#output-gen-config}
         ...
         - [Komponentenzuordnung für AEM Sites](./install-guide/component-mapping.md)
      ...
      - Arbeiten mit der Replikation von DITA-Assets{#dita-assets-replication}
         - [Konfigurieren der DITA-Asset-Replikation](./install-guide/configure-dita-asset-replication.md)
   ...
   - Cloud Services {#cs-ig}
      ...
      - Bereitstellen und Konfigurieren von AEM Guides as a Cloud Service {#deploy-conf-aemg-cs}
         ...
         - [Zusätzliche Konfiguration für das Upgrade von AEM Guides as a Cloud Service](./cs-install-guide/additional-config-for-cloud-service.md)
      ...
      - Arbeiten mit Ausgabegenerierungseinstellungen {#output-gen-config-cs}
         ...
         - [Komponentenzuordnung für AEM Sites](./cs-install-guide/component-mapping.md)
      ...
      - Arbeiten mit der Replikation von DITA-Assets {#dita-assets-replication-cs}
         - [Konfigurieren der DITA-Asset-Replikation](./cs-install-guide/configure-dita-assets-replication.md)
