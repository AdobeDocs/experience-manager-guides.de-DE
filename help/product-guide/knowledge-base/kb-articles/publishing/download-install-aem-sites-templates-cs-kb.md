...
2. **Paket zum Projektmodul hinzufügen:**
   1. Erstellen Sie in Ihrem lokal geklonten Repository ein neues Projektmodul oder fügen Sie es einem vorhandenen Modul hinzu.
   2. Stellen Sie sicher, dass die Struktur `/jcr_root/apps/fmdita/` Installation vorhanden ist.
...
1. **Neue Vorgabe erstellen:**
   ...
   5. Deaktivieren Sie die Einstellung **Veraltete Komponentenzuordnung verwenden**.
      ...
      ![Neue AEM-Site-Voreinstellung erstellen](/help/product-guide/knowledge-base/kb-articles/assets/publishing/create-new-output-preset.png){width="350"}
...
1. **Website generieren:**
   ...
   2. Die generierte Site ist unter folgendem Pfad verfügbar: `/content/AEMG-Docs-Site/en/docs/product`.
