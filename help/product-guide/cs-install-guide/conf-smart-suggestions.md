...
4. [Fügen Sie die Variable GUIDES_AI_SITE_ID in der Umgebung hinzu](#add-the-guides_ai_site_id-variable-in-the-environment)
5. [Änderungen auf die Umgebung anwenden](#apply-changes-to-the-environment)
6. [Aktivieren des KI-Assistenten im Ordnerprofil](#enable-ai-assistant-in-folder-profile)
7. [Konfigurieren von Smart-Vorschlägen im Ordnerprofil](./conf-folder-level.md#configure-ai-assistant-for-smart-help-and-authoring)
...
## Fügen Sie die Variable GUIDES_AI_SITE_ID in der Umgebung hinzu

Fügen Sie die Variable `GUIDES_AI_SITE_ID` in Ihrer Umgebung (Cloud Manager) hinzu und legen Sie den Wert auf `id_f651abc807c84f52b425737bb93f87ba` fest, um sie zu aktivieren.
