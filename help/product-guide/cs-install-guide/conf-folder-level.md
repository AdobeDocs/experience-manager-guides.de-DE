...
1. Informationen zum Konfigurieren von **Vorlagen** finden Sie unter [Konfigurieren von Authoring-Vorlagen](#id1889D0IL0Y4).
...
Sie können auch vor dem Konfigurieren der Themen-, Zuordnungs- oder PDF-Vorlagen auf globaler oder Ordnerebene einen Speicherort für Ihre benutzerdefinierten Vorlagen definieren. Informationen zum Konfigurieren eines benutzerdefinierten Speicherorts zum Speichern der Vorlagen finden Sie unter [Benutzerdefinierten Ordnerpfad der DITA-Vorlage konfigurieren](conf-template-tags-custom-dita-topic-template.md#id191LCF0095Z).
...
1. Wählen Sie auf der Profilseite die Registerkarte **AI-Konfiguration** aus.
...
Erfahren Sie mehr darüber, wie Sie [KI-basierte intelligente Vorschläge](../user-guide/authoring-ai-based-smart-suggestions.md) anzeigen und hinzufügen können, um beim Authoring im Web Editor Inhaltsverweise hinzuzufügen.
