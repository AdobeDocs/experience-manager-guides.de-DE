...
| Einstellungsname | Geben Sie einen beschreibenden Namen für die EPUB-Ausgabeeinstellungen ein, die Sie erstellen. Sie können beispielsweise die Ausgabe _Interne Kunden_ oder die Ausgabe _der Endbenutzer_ angeben. |
