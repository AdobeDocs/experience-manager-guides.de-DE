...
description: Erfahren Sie, wie Sie eine HTML5-Vorgabe über den Web-Editor und das Zuordnungs-Dashboard erstellen. Konfigurieren der HTML5-Ausgabevoreinstellung in AEM Guides.
...
| Generieren eines responsiven Formulars mit | Wählen Sie DITA-OT, um die HTML5-Ausgabe zu erzeugen. |
