...
>[!NOTE]
>
>Sie können auch anklickbare Bereiche \(Imagemap\) in Ihrem Bild definieren. Weitere Informationen finden Sie in der Beschreibung **Bildzuordnung einfügen/bearbeiten** im Abschnitt [Linkes Bedienfeld](web-editor-left-panel.md).
...
> - Der Weblink-Referenztyp fügt standardmäßig immer scope=`external` ein und fügt die URL unverändert hinzu, ohne dass Änderungen vorgenommen werden. Dieses Verhalten gilt konsistent sowohl für relative als auch für absolute Pfade, und zwar für alle unterstützten URL-Typen, einschließlich HTTP/S und FTP/S.
