...
>[!NOTE]
>
> Wenn Sie an einer Zuordnungsdatei arbeiten, werden im Inhaltsbearbeitungsbereich verschiedene Optionen oder Ansichten angezeigt. Weitere Informationen finden Sie unter [Funktionen des Zuordnungs-Editors](./map-editor-advanced-map-editor.md).
