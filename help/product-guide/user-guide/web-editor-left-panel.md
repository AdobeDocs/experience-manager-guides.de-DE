...
1. Drücken Sie die Eingabetaste oder wählen Sie **Search** Symbol \( ![](images/search-icon.svg)\) aus, um den suchen durchzuführen.
...
1. Wählen Sie **Ersetzen einzelne Vorkommen** \( ![](images/replace-icon.svg)\) aus, um den aktuell hervorgehobenen suchen Begriff im Thema zu ersetzen, oder wählen Sie Weiter Übereinstimmung ![](images/next-match-in-search.png) oder ![](images/previous-match-in-search.png) Zurück Übereinstimmung aus, um zur nächsten oder vorherigen Vorkommen des Textes zu gelangen.
...
1. Sie können Ihre Projekte auch wie folgt filtern:
   ...
   - Wählen Sie ![](images/filter-search-icon.svg) aus, um das Dialogfeld **Filter** zu öffnen. Sie können alle oder nur bestimmte Projekte auswählen. Die ausgewählten Projekte werden im **Bedienfeld &quot;prüfen** &quot; aufgeführt.
