...
Weitere Informationen finden Sie unter [Konfigurieren des Titels für die Symbole zum Ein- und Auschecken](../install-guide/conf-checkin-checkout-title.md) im On-Premise-Installations- und Konfigurationshandbuch.
