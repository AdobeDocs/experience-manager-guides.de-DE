...
description: Erfahren Sie, wie Sie eine PDF-Vorgabe über den Web-Editor und das Zuordnungs-Dashboard erstellen. Konfigurieren der PDF-Ausgabevorgabe in AEM Guides.
feature: Publishing
role: User
hide: true
...
>[!NOTE]
>
> Sie können die Methode zum Generieren von PDF mithilfe des DITA-OT, des nativen PDF oder des FMPS auswählen (sofern dies von Ihrem Systemadministrator konfiguriert wurde\).
...
Um Ausgabevorgaben für PDF zu öffnen, klicken Sie in der Assets-Benutzeroberfläche auf eine DITA-Zuordnungsdatei, klicken Sie dann auf Ausgabevorgaben und dann auf die Option PDF . Klicken Sie im Zuordnungs-Dashboard oben auf **Bearbeiten**, um die verschiedenen Konfigurationen zu aktualisieren, und klicken Sie dann auf **Speichern**.
