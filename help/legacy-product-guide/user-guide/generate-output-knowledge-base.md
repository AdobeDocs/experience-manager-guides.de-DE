...
| --- | --- |
| Publish-Profil | Verwenden Sie das Dropdown-Menü, um aus den Salesforce-Verbindungsprofilen auszuwählen, die Ihr Administrator konfiguriert. Weitere Informationen dazu, wie Ihr Administrator ein Veröffentlichungsprofil erstellen kann, finden Sie in der Funktionsbeschreibung **Editor Settings** im Abschnitt [Left Panel](./web-editor-features.md#id2051EA0M0HS) . |
...
>[!NOTE]
>
>Sie können die Vorgabe der Adobe Experience Manager Knowledge Base verwenden, wenn Ihr Administrator sie konfiguriert hat. Weitere Informationen finden Sie unter [Artikelbasierte Veröffentlichung im Web-Editor](/help/product-guide/install-guide/configure-article-based-publishing.md) im Installations- und Konfigurationshandbuch.
